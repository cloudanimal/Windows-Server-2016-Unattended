...
{  
  <#  
   ...
   .Description  
    The New-WinIso cmdlet creates a new .iso file containing content from chosen folders  
   .Example  
    New-WinIso "c:\tools","c:Downloads\utils"  
   ...
   .Example 
    New-WinIso -FromClipboard -Verbose 
    Before running this command, select and copy (Ctrl-C) files/folders in Explorer first.  
   .Example  
    dir c:\WinPE | New-WinIso -Path c:\temp\WinPE.iso -BootFile "${env:ProgramFiles(x86)}\Windows Kits\10\Assessment and Deployment Kit\Deployment Tools\amd64\Oscdimg\efisys.bin" -Media DVDPLUSR -Title "WinPE" 
